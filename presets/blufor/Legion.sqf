...
crewman_classname = "legion_recruit_01_body";                               // This defines the crew for vehicles.
pilot_classname = "legion_recruit_01_body";                          // This defines the pilot for helicopters.
...
*/
infantry_units = [
  ["legion_cent_01_body",10,0,0],
  ["legion_recruit_06_body",10,0,0],
  ["legion_recruit_14_body",10,0,0],
  ["legion_recruit_08_body",10,0,0],
  ["legion_frum_01_body",10,0,0],
  ["legion_legate_01_body",10,0,0],
  ["legion_recruit_13_body",10,0,0],
  ["legion_recruit_05_body",10,0,0],
  ["legion_recruit_07_body",10,0,0],
  ["legion_pret_01_body",10,0,0],
  ["legion_decan_01_body",10,0,0],
  ["legion_recruit_11_body",10,0,0],
  ["legion_recruit_04_body",10,0,0],
  ["legion_recruit_09_body",10,0,0],
  ["legion_recruit_01_body",10,0,0],
  ["legion_recruit_03_body",10,0,0],
  ["legion_decan_02_body",10,0,0],
  ["legion_recruit_02_body",10,0,0],
  ["legion_recruit_12_body",10,0,0],
  ["legion_recruit_10_body",10,0,0],
  ["legion_vexil_01_body",10,0,0]
];
...
blufor_squad_inf_light = [
  "legion_recruit_06_body",
  "legion_recruit_11_body",
  "legion_recruit_12_body",
  "legion_recruit_09_body",
  "legion_recruit_10_body",
  "legion_recruit_01_body",
  "legion_recruit_02_body",
  "legion_recruit_07_body"
];
...
blufor_squad_inf = [
  ...
  "legion_recruit_05_body",
  "legion_recruit_08_body",
  "legion_recruit_11_body",
