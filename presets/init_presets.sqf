...
switch (KP_liberation_preset_blufor) do {
    case  1: {[] call compileFinal preprocessFileLineNumbers "presets\blufor\Brotherhood.sqf";};
    case  2: {[] call compileFinal preprocessFileLineNumbers "presets\blufor\Enclave.sqf";};
    case  3: {[] call compileFinal preprocessFileLineNumbers "presets\blufor\Legion.sqf";};
    case  4: {[] call compileFinal preprocessFileLineNumbers "presets\blufor\Jackals.sqf";};
    case  5: {[] call compileFinal preprocessFileLineNumbers "presets\blufor\Boniche.sqf";};
    default  {[] call compileFinal preprocessFileLineNumbers "presets\blufor\Boniche.sqf";};
};

switch (KP_liberation_preset_opfor) do {
    case  1: {[] call compileFinal preprocessFileLineNumbers "presets\opfor\Brotherhood.sqf";};
    case  2: {[] call compileFinal preprocessFileLineNumbers "presets\opfor\Enclave.sqf";};
    case  3: {[] call compileFinal preprocessFileLineNumbers "presets\opfor\Legion.sqf";};
    case  4: {[] call compileFinal preprocessFileLineNumbers "presets\opfor\Jackals.sqf";};
    case  5: {[] call compileFinal preprocessFileLineNumbers "presets\opfor\Zombies.sqf";};
    default  {[] call compileFinal preprocessFileLineNumbers "presets\opfor\Zombies.sqf";};
};

switch (KP_liberation_preset_resistance) do {
    case  1: {[] call compileFinal preprocessFileLineNumbers "presets\resistance\Fiends.sqf";};
    case  2: {[] call compileFinal preprocessFileLineNumbers "presets\resistance\Khans.sqf";};
    case  3: {[] call compileFinal preprocessFileLineNumbers "presets\resistance\Chernarus.sqf";};
    default  {[] call compileFinal preprocessFileLineNumbers "presets\resistance\Chernarus.sqf";};
};

switch (KP_liberation_preset_civilians) do {
    case  1: {[] call compileFinal preprocessFileLineNumbers "presets\civilians\VanillaA3.sqf";};
    case  2: {[] call compileFinal preprocessFileLineNumbers "presets\civilians\Wastelanders.sqf";};
    default  {[] call compileFinal preprocessFileLineNumbers "presets\civilians\VanillaA3.sqf";};
};
