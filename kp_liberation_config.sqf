...
if ((paramsArray select 3) == 0) then{
    ...
    //[] execVM "ships\despawnMunificent.sqf";
}
else{
	if ((paramsArray select 3) == 1) then{
		KP_liberation_preset_blufor = 2;
		//[] execVM "ships\despawnAcclamator.sqf";
	}
	else{
...
GRLIB_battlegroup_size = 24;                                            // Size of enemy battlegroups.
...
KPLIB_transportConfigs = [
    ...
    ["B_T_VTOL_01_infantry_BoS_F", -7.5,[0,4.7,-4.88],[0,3,-4.88],[0,1.3,-4.88],[0,-0.4,-4.88],[0,-2.1,-4.88]],
    ["B_T_VTOL_01_vehicle_BoS_F", -7.5,[0,4.7,-4.88],[0,3,-4.88],[0,1.3,-4.88],[0,-0.4,-4.88],[0,-2.1,-4.88]],
    ["B_T_VTOL_01_vehicle_ENC_F", -7.5,[0,4.7,-4.88],[0,3,-4.88],[0,1.3,-4.88],[0,-0.4,-4.88],[0,-2.1,-4.88]],
    ["B_T_VTOL_01_infantry_ENC_F", -7.5,[0,4.7,-4.88],[0,3,-4.88],[0,1.3,-4.88],[0,-0.4,-4.88],[0,-2.1,-4.88]],
    ["B_T_VTOL_01_infantry_NCR_F", -7.5,[0,4.7,-4.88],[0,3,-4.88],[0,1.3,-4.88],[0,-0.4,-4.88],[0,-2.1,-4.88]],
    ["B_T_VTOL_01_vehicle_NCR_F", -7.5,[0,4.7,-4.88],[0,3,-4.88],[0,1.3,-4.88],[0,-0.4,-4.88],[0,-2.1,-4.88]],
    ...
    ["B_G_Offroad_01_F", -6.5, [0,-1.7,0.4]],
