...
if(isServer) then {
    ...
    // Mission Options
    ["--- Aftermath Options ---", "PARAM"] call KPLIB_fnc_log;
    GET_PARAM(KP_liberation_preset_blufor, "Blufor_Faction", 4);
    GET_PARAM(KP_liberation_preset_opfor, "Opfor_Faction", 2);
    GET_PARAM(KP_liberation_preset_resistance, "Resistance_Faction", 1);
    GET_PARAM(KP_liberation_preset_civilians, "Civilian_Faction", 1);
    GET_PARAM_BOOL(anomalyActive, "Anomalies_Active", 0);
    GET_PARAM(anomalyAmountCount, "Anomaly_Count", 0);
...
if (!isDedicated && hasInterface) then {
    ...
    _param = localize "STR_BLUFOR_FACTION";
    switch (KP_liberation_preset_blufor) do {
        case 1: {_value = localize "STR_BLUFOR_FACTION2";};
        case 2: {_value = localize "STR_BLUFOR_FACTION3";};
        case 3: {_value = localize "STR_BLUFOR_FACTION4";};
        case 4: {_value = localize "STR_BLUFOR_FACTION5";};
        default {_value = localize "STR_BLUFOR_FACTION1";};
    };
    ...
    _value = if (KP_liberation_fob_vehicle) then {localize "STR_PARAMS_FIRSTFOBVEHICLE_TRUCK";} else {localize "STR_PARAMS_FIRSTFOBVEHICLE_CONTAINER";};
    _text = _text + format ["<font color='#ff8000'>%1</font><br />%2<br /><br />", _param, _value];
