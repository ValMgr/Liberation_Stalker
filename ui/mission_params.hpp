class Params {
    ...
    //Added for Aftermath modification.
    class AftermathOptions {
        title = $STR_PARAMS_AFTERMATH;
        values[] = {""};
        texts[] = {""};
        default = "";
    };
    class Blufor_Faction {
        title = $STR_BLUFOR_FACTION;
        values[] = {0, 1, 2, 3, 4};
        texts[] = {$STR_BLUFOR_FACTION1, $STR_BLUFOR_FACTION2, $STR_BLUFOR_FACTION3, $STR_BLUFOR_FACTION4, $STR_BLUFOR_FACTION5};
        default = 4;
    };
    class Opfor_Faction {
        title = $STR_OPFOR_FACTION;
        values[] = {0, 1, 2, 3, 4};
        texts[] = {$STR_OPFOR_FACTION1, $STR_OPFOR_FACTION2, $STR_OPFOR_FACTION3, $STR_OPFOR_FACTION4, $STR_OPFOR_FACTION5};
        default = 4;
    };
    class Resistance_Faction {
        title = $STR_RESISTANCE_FACTION;
        values[] = {0, 1, 2};
        texts[] = {$STR_RESISTANCE_FACTION1, $STR_RESISTANCE_FACTION2, $STR_RESISTANCE_FACTION3};
        default = 2;
    };
    class Civilian_Faction {
    ...
    class Anomalies_Active {
        ...
        values[] = {0, 1};
        texts[] = {$STR_ANOMALIES_ACTIVE1, $STR_ANOMALIES_ACTIVE2};
        default = 1;
    };
    class Anomaly_Count {
    ...
    class FirstFobVehicle {
        ...
        values[] = {0, 1};
        texts[] = {$STR_PARAMS_FIRSTFOBVEHICLE_CONTAINER, $STR_PARAMS_FIRSTFOBVEHICLE_TRUCK};
        default = 1;
    };
    class MaximumFobs {
